...
//    }
    ...
    function insert($dataObject,$forceId=false)
    {
        ...
        $sqlRequestPropertiesWhereInsert = 'INSERT INTO '.$this->getBase().'.'.$table.'(';
    ...
    function update($dataObject){
        ...
        $sql = 'UPDATE '.$this->getBase().'.'.get_class($dataObject).' SET ';
