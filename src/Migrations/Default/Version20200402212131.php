 ...
 */
final class Version20200402212131 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_83DFDFA49395C3F3 ON contact (customer_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_83DFDFA49395C3F3 ON Contact');
    }
}
