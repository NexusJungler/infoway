 ...
 */
final class Version20200331103450 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE User (id INT AUTO_INCREMENT NOT NULL, perimeter_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, first_name VARCHAR(30) NOT NULL, last_name VARCHAR(30) NOT NULL, phone_number VARCHAR(30) DEFAULT NULL, account_confirmation_token VARCHAR(255) DEFAULT NULL, password_reset_tocken VARCHAR(255) DEFAULT NULL, requested_password_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, activated TINYINT(1) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2DA17977E7927C74 (email), INDEX IDX_2DA1797777570A4C (perimeter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users_permissions (user_id INT NOT NULL, permission_id INT NOT NULL, INDEX IDX_DA58F09DA76ED395 (user_id), INDEX IDX_DA58F09DFED90CCA (permission_id), PRIMARY KEY(user_id, permission_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Customer (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, timezone_id INT DEFAULT NULL, name VARCHAR(60) NOT NULL, logo VARCHAR(60) NOT NULL, address VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(60) DEFAULT NULL, city VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_784FEC5F5E237E06 (name), UNIQUE INDEX UNIQ_784FEC5FE48E9A13 (logo), INDEX IDX_784FEC5FF92F3E70 (country_id), INDEX IDX_784FEC5F3FE997DE (timezone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_roles (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, role_id INT NOT NULL, customer_id INT NOT NULL, INDEX IDX_54FCD59FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
